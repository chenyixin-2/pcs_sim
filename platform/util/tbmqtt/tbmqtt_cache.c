...
struct tbmqtt_cache_sqlite_data {
    int* rowid;
    void* data;
};
...
static int callback_read_one_item(void* para, int ncolumn, char** columnvalue, char* columnname[])
{
    struct tbmqtt_cache_sqlite_data *stTemp = (struct tbmqtt_cache_sqlite_data *)para;
    tbmqtt_ringbuffer_element_t* e = (tbmqtt_ringbuffer_element_t *)(stTemp->data);
